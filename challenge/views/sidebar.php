        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                <img src="https://1000logos.net/wp-content/uploads/2018/02/BMW-Logo-1963.png" alt="User Avatar" class="img-size-50 mr-3 img-circle">
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="media">
                <img src="https://1000logos.net/wp-content/uploads/2018/02/BMW-Logo-1963.png" alt="User Avatar" class="img-size-50 img-circle mr-3">
                <div class="media-body">
                  <h3 class="dropdown-item-title">
                    John Pierce
...
<script>
  $(document).ready(function() {
    ...
    <?php if (isset($_GET['message_delete'])) : ?>
